...
void ride(vector <Customers> &customers, vector <Orders> &orders, vector <Inquiries> &inquiries, int* sId){
    ...
    int pickuphour = currentHour;
    int pickupmin = currentMin + 40;
    if (pickupmin > 60){
        pickupmin = currentMin;
        pickuphour = currentHour + 1;

        // if (pickuphour > 24){
        //     pickuphour = 0;
        //     pickupmin = currentMin + 40 - 60 ;
        // }
    }
    ...
    cout << " ------------------------------------------------\n";
    cout << " Please select a service: \n";
    cout << "  1. Taxi\t\t4 people\t$10.00\t" << pickuphour << ":" << pickupmin <<"(Pick up) \n";
    cout << "  2. Van\t\t5 people\t$15.00\t" << pickuphour << ":" << pickupmin <<"(Pick up) \n";
    cout << "  3. Premium Van\t6 people\t$20.00\t" << pickuphour << ":" << pickupmin <<"(Pick up) \n";
    cout << " ------------------------------------------------\n";
    cout << "  Enter option: ";
    cin >> o.selectedService;
